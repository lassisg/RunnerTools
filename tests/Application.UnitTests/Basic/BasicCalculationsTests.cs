...
public class BasicCalculationsTests
{
    ...
    public void ShouldReturnCorrectTargetCadence(decimal distance, int durationHours, int durationMinutes,
                                                 int durationSeconds,
                                                 int targetCadenceMinutes, int targetCadenceSeconds)
    {
    ...
    public void ShouldReturnCorrectTargetSpeed(decimal distance, int durationHours, int durationMinutes,
                                               int durationSeconds,
                                               decimal targetSpeed)
    {
        var duration = new TimeSpan(durationHours, durationMinutes, durationSeconds);
    ...
    public void ShouldReturnCorrectTargetDuration(decimal distance, int cadenceMinutes, int cadenceSeconds,
                                                  int targetDurationHours, int targetDurationMinutes,
    ...
    {
        Action act = () => BasicCalculations.SpeedToCadence(speed);
    ...
    {
        var cadence = new TimeSpan(0, cadenceMinutes, cadenceSeconds);
        Action act = () => BasicCalculations.CadenceToSpeed(cadence);
